...
//Es codigo reutilizable que funciona con multiples tipos
//Pueden ser funciones, intefaces o clases

// Por lo general se representan con una <T>

// Por lo general se usa para reutilizar clases en los casos que se ocupe utilizar clases similares, ya que no tiene sentido copiar y pegar casi el mismo codigo
...
} // El extends en el generic sirve por si acaso se quiere acceder a propiedades de objetos que aun no estan definidas 
